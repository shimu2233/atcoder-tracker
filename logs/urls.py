...
from .views import DashboardView,TopView,ContestProblemsView,DailyTrainingView,sync_view,UnsolvedListView,DoLaterListView,toggle_do_later,LearningContentsView,LearningContentDetailView
urlpatterns=[
